				...
				<div className="grid gap-8 max-md:grid-cols-1 md:grid-cols-4">
					...
					<div className="max-md:text-center space-y-3">
						...
						<div className="flex flex-col items-center gap-2 md:items-start">
							<a href="/tentang" className="text-putih/60 hover:text-merah text-sm transition-colors">Tentang Kami</a>
							<a href="/redaksi" className="text-putih/60 hover:text-merah text-sm transition-colors">Redaksi</a>
							<a href="/pedoman-media-siber" className="text-putih/60 hover:text-merah text-sm transition-colors">Pedoman Media Siber</a>
						</div>
					</div>
					<div className="max-md:text-center space-y-3">
						<h4 className="text-merah text-sm font-bold uppercase mb-3">Ikuti Kami</h4>
						<div className="flex flex-col items-center gap-2 md:items-start">
							<a href="/dasar-privasi" className="text-putih/60 hover:text-merah text-sm transition-colors">Dasar Privasi</a>
							<a href="/iklan" className="text-putih/60 hover:text-merah text-sm transition-colors">Pengiklanan</a>
						</div>
					</div>
				</div>
				{site?.footerText && (
					<div className="border-t border-putih/10 pt-6 text-center">
						<p className="text-putih/50 text-xs italic">{site.footerText}</p>
					</div>
				)}
				<div className="border-t border-putih/10 pt-8">
					<div className="max-w-md mx-auto text-center space-y-3">
						<h4 className="text-merah text-sm font-bold uppercase">📬 Langgan Newsletter</h4>
						<p className="text-putih/50 text-xs">Dapatkan berita terkini terus ke inbox anda. Tiada spam.</p>
